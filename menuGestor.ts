  ...
  switch (opcion) {
    ...
    case "2":
      const buscar = readlineSync.questionInt(
        "ID de la veterinaria a actualizar:"
      );
      ...
      break;
    case "3":
      const buscarId = readlineSync.questionInt(
...
export function gestionarProveedores(redVeterinaria: RedVeterinaria): void {
  ...
  switch (opcion) {
    ...
    case "2":
      ...
      const nuevoNombreProv:string = readlineSync.question("Nuevo nombre: ");
      const nuevoTelefono:string = readlineSync.question("Nuevo telefono: ");
      redVeterinaria.modificarProveedor(buscar, nuevoNombreProv, nuevoTelefono);
      break;
    case "3":
      const buscarIdProv = readlineSync.questionInt(
